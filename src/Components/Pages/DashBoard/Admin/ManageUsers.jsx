...
const ManageUsers = () => {
    const { allUsers, isLoading, refetch } = useManageUsers()
    ...
    return (
        <div className="p-5">
            ...
            <h1 className="text-4xl font-semibold mb-8">Manage All Users :</h1>

            <InfiniteScroll dataLength={allUsers.length} next={allUsers} height={500}>
